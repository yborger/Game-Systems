...
.setJunkFoodVerticalSpeedAdvanced
   ...
   bne .checkForDecaying        ; branch if not Candy Canes or Ice Cream wave
...
JunkFoodColors
HamburgerColors
   .byte RED + 4, RED + 4, RED + 4, RED + 4, RED + 4, RED + 4
   .byte RED + 4, RED + 4, RED + 4, RED + 4, RED + 4, RED + 4
StrawberriesColors
   .byte RED_ORANGE + 8, RED_ORANGE + 8, RED_ORANGE + 8, RED_ORANGE + 8, RED_ORANGE + 8, RED_ORANGE + 8
   .byte RED_ORANGE + 8, RED_ORANGE + 8, RED_ORANGE + 8, RED_ORANGE + 8, RED_ORANGE + 8, RED_ORANGE + 8
HotdogColors
   .byte GREEN + 6, GREEN + 6, GREEN + 6, GREEN + 6, GREEN + 6, GREEN + 6
   .byte GREEN + 6, GREEN + 6, GREEN + 6, GREEN + 6, GREEN + 6, GREEN + 6
GumDropsColors
   .byte BLUE + 4, BLUE + 4, BLUE + 4, BLUE + 4, BLUE + 4, BLUE + 4
   .byte BLUE + 4, BLUE + 4, BLUE + 4, BLUE + 4, BLUE + 4, BLUE + 4
FriesColors
   .byte PURPLE, PURPLE, PURPLE, PURPLE, PURPLE, PURPLE
   .byte PURPLE, PURPLE, PURPLE, PURPLE, PURPLE, PURPLE
DonutsColors
   .byte RED, RED, RED, RED, RED, RED
   .byte RED, RED, RED, RED, RED, RED
CandyCanesColors
   .byte PURPLE - 6, PURPLE - 6, PURPLE - 6, PURPLE - 6, PURPLE - 6, PURPLE - 6
   .byte PURPLE - 6, PURPLE - 6, PURPLE - 6, PURPLE - 6, PURPLE - 6, PURPLE - 6
IceCreamConesColors
   .byte GREEN + 1, GREEN + 1, GREEN + 1, GREEN + 1, GREEN + 1, GREEN + 1
   .byte GREEN + 1, GREEN + 1, GREEN + 1, GREEN + 1, GREEN + 1, GREEN + 1
